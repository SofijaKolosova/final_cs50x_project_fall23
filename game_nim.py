# we will implement a game of Nin
# we need to store game state which will be just a number of stones
# we also need to store the current player

STARTING_STONES = 21 #Im Python uppercase means constant but it is not enforced
...
while STARTING_STONES > 0:
    ...
    player_move = int(input(f"{current_player} wuold you like to remove 1 or 2 stones?"))
...
#print the winner - we use misere game rules - meaning the player who the last stone loses
